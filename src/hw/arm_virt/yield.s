...
__platform_yield:
  ...
  // Note: we do not use r0/r1 here, they might be semihosting args
  ldr r2, [lr, #-4]        // load svc instruction used
  ldr r3, =0xFFFFFF        // mask to get code
  and r2, r2, r3           //
  ldr r3, =0x00dead        // thread switch
  cmp r2, r3
  beq switch_thread
  ldr r3, =0x123456        // semihosting call
  cmp r2, r3
  beq semihosting
  ldr r2, =unknown_monitor_call_err
  b qemu_print
  b qemu_exit
