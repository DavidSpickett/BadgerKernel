...
void print_register_context(RegisterContext ctx) {
  ...
  printf("       x0: 0x%16x   x1: 0x%16x  x2: 0x%16x  x3: 0x%16x\n"
         ...
         ctx.x0, ctx.x1, ctx.x2, ctx.x3, ctx.x4, ctx.x5, ctx.x6, ctx.x7, ctx.x8,
         ctx.x9, ctx.x10, ctx.x11, ctx.x12, ctx.x13, ctx.x14, ctx.x15, ctx.x16,
         ctx.x17, ctx.x18, ctx.x19, ctx.x20, ctx.x21, ctx.x22, ctx.x23, ctx.x24,
         ctx.x25, ctx.x26, ctx.x27, ctx.x28, ctx.x29, ctx.x30, ctx.pc,
  ...
  printf("  r0: 0x%08x r1: 0x%08x  r2: 0x%08x   r3: 0x%08x\n"
         ...
         ctx.r0, ctx.r1, ctx.r2, ctx.r3, ctx.r4, ctx.r5, ctx.r6, ctx.r7, ctx.r8,
         ctx.r9, ctx.r10, ctx.r11, ctx.r12, ctx.lr, ctx.pc, ctx.xpsr);
  ...
  printf("  r0: 0x%08x r1: 0x%08x  r2: 0x%08x   r3: 0x%08x\n"
         ...
         ctx.r0, ctx.r1, ctx.r2, ctx.r3, ctx.r4, ctx.r5, ctx.r6, ctx.r7, ctx.r8,
         ctx.r9, ctx.r10, ctx.r11, ctx.r12, ctx.lr, ctx.pc, ctx.cpsr);
#else
